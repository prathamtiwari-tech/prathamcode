...
public class GenericDemo4 <T> {
	...
	<E extends T> GenericDemo4(E object) { }
	//<E> GenericsDemo4(E object) {}
	//GenericsDemo4(T object) { }
	//<E extends T> GenericsDemo4() {}
...
//		Integer intVal = typeArgInferenceFromTargetType1(); 
		...
		GenericDemo4.targetTypeInvoker1(typeArgInferenceFromTargetType2()); // Eclipse Mars showing incorrect type arg
		GenericDemo4.targetTypeInvoker1(new ArrayList<>()); // Eclipse Mars showing incorrect type arg
		GenericDemo4.targetTypeInvoker2(typeArgInferenceFromTargetType2()); // Infers as Object
		List<String> strList = GenericDemo4.targetTypeInvoker2(typeArgInferenceFromTargetType2());
		GenericDemo4.targetTypeInvoker2(new ArrayList<>());
		List<String> strList2 = GenericDemo4.targetTypeInvoker2(new ArrayList<>());
		...
		GenericDemo4.<String>uselessGenericMethod(); // type witness
		
		// Explicit Type Argument Specification: Type witness. Comment out Generic constructor!!
		// GenericsDemo4.<GenericsDemo4>typeArgInference(new GenericsDemo4());
		...
		new GenericDemo4<Number>(12.0); // T is Number, E is Double
		new GenericDemo4<>(12.0); // T & E are Double
		new <Double>GenericDemo4<Number>(12.0); // Type witness!!
		//new <Double>GenericsDemo4<>(12.0); // Could have inferred from arg
		GenericDemo4<Number> gd = new GenericDemo4<>(12.0); // To avoid invariance, smartly infers Number for <> rather than Double 
